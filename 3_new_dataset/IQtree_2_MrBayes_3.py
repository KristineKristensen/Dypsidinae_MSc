...
make_log= "\t log start filename="+genes+"_3.log replace;\n"
file_to_execute= "\t Execute /home/kris/dypsidinae/C_large_dataset/7.Nex_files/"+genes+"_no_X-out.nex;\n"
...
block.append("\t mcmc ngen=5000000 samplefreq=2500 printfreq=2500 diagnfreq=2500, append=yes;\n ")
block.append("\t sump;\n")
block.append("END;")

#Write MrBayes block
MrBayes_block = open(genes+"_MrBayes_block_3.nex", 'w')
for i in block:
