...
os.chdir("/home/kris/dypsidinae/data/nexfiles/")
#converting the files
Phylo.convert(genes+".fasta-out.nex.run1.t", "nexus", genes+".fasta-out.nex.run1_newick.t", "newick")
Phylo.convert(genes+".fasta-out.nex.run2.t", "nexus", genes+".fasta-out.nex.run2_newick.t", "newick")

#excluding burnin and creating files
newick_1=open(genes+".fasta-out.nex.run1_newick.t","r").readlines()
run1=document[-500:] #taking the last 500 tree generated by MrBayes
newick_2=open(genes+".fasta-out.nex.run2_newick.t","r").readlines()
run2=document[-500:]
