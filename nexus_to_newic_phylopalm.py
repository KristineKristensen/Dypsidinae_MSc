...
Phylo.convert(genes+".fasta_no_X-out.nex.run1.t", "nexus", genes+".fasta-out.nex.run1_newick.t", "newick")
Phylo.convert(genes+"..fasta_no_X-out.nex.run2.t", "nexus", genes+".fasta-out.nex.run2_newick.t", "newick")
