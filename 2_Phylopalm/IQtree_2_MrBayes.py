...
os.chdir("/home/kris/dypsidinae/B_phylopalm/3.MrBayes/")
...
IQtree_result=open("/home/kris/dypsidinae/B_phylopalm/1.IQtree/"+genes+".iqtree").readlines()
...
file_to_execute= "\t Execute /home/kris/dypsidinae/B_phylopalm/2.Nex_files/"+genes+"_no_X-out.nex;\n"
...
block.append("\t mcmc ngen=2500000 samplefreq=2500 printfreq=2500 diagnfreq=2500;\n ")
block.append("\t sump;\n")
block.append("END;")
